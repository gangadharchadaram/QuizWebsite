    ...
    <div className="add-question">
        <div className="admin-aside">
				...
				<ul className="nav">
					...
					<li><a href="#services"><i className="fa fa-list"></i>Dashboard</a></li>
			...
			<div className="rside">
				<div className="header header-main">
					<span className="button__text" onClick={() => navigate("/")}>Home</span>
					<button className="create-quiz-button" onClick={() => navigate("/take-quiz")}>
