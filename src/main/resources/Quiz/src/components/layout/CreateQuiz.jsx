...
import '/home/gangadhar/quiz/src/main/resources/Quiz/src/components/layout/CreateQuiz.css';
...
const CreateQuiz = () => {
  ...
  return (
    <div className="container">
      <div className="admin-aside">
        ...
        <ul className="nav">
            ...
            <li><a href="/all-quizzes"><i className="fa fa-briefcase"></i>All Question</a></li>
    ...
    <div className="header header-main">
            <span className="button__text" onclick="getLogin()">Quiz</span>
